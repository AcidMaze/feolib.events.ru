                    ...
                    <?php $form = ActiveForm::begin(['id' => 'review-form']); ?>
                        <div class="row">
                            <div class="form-group col-md-12">
                                <?= $form->field($review_model, 'rev_text', ['template'=> "{input}"])->textArea(['type' => 'text', 'style' => 'background-color: #ddfeed;  border-radius: 5px; max-height: 450px', 'placeholder' => 'Введите текст отзывы', 'rows' => '8', 'class '=> 'form-control form-control-lg'])->label(false);?>
                            </div>
                            <div class="form-group col-md-12">
            ...
            foreach ($models as $model) {
                ...
                echo "
                    <div class = 'mt-2 col-lg-12 review-block'>
                        ...
                        <div class = 'pt-4 pb-1 col-lg-10' style = 'border-radius: 15px; min-height: 190px; max-height: 550px; background: #ddfeed;'>
                            <p class = 'my-auto p_style-10'>
                                $model->rev_text
                            </p>
                            
                        </div>
                        <div class = 'like-block p_style-14' data-id = '$rev_id'>
                            <span type = 'button' class='iconify' data-icon='flat-color-icons:like'></span>
                            $model->rev_like
                            <span type = 'button' class='iconify' data-icon='flat-color-icons:dislike'></span>
                            $model->rev_dislike
                        </div>
                    </div>
