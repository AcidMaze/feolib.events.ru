                ...
                <?php
                    ...
                    else
                    {
                        ...
                        echo"
                            ...
                            <ul class='account_selection'>
                                <li><a href='$url'><i class='bi bi-person-circle'></i>Мой профиль</a></li>
                                <li><a href='$url2'><i class='bi bi-envelope'></i>Мои сообщения</a></li>
                                <li><a href='$url3'><i class='bi bi-box-arrow-left'></i>Выйти</a></li>
                            </ul>
                        ";
                    }
                ?>
...
<footer class="text-center mt-3 text-lg-start text-muted">
  <div class="text-center p-4" style="background-color: #92E3A9; color: #FFFFFF;">
